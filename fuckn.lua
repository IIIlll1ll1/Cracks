...
repeat
    task.wait()
until game:IsLoaded()
local OrionLib = loadstring(game:HttpGet("https://raw.githubusercontent.com/IIIlll1ll1/Cracks/main/orion_mobile_phone.lua", true))()
...
----------------------------------------------------------------------------------------------------------------------------------------
local window = library:new("小皮中心444cnmdnmsbsb123")--V2.1.3
----------------------------------------------------------------------------------------------------------------------------------------
...
LOL:Label("你的用户名" .. lp.Name .. " ")
LOL:Label("云脚本中心2群号")
LOL:Button(
    "复制到云脚本①群号（如果找不到）",
    function()
        setclipboard("武士,江 脚本作者你们等着")
    end
)
LOL:Button(
    "复制到狗脚本①链接（QQ可发送）",
...
FM:Button(" 忍  -- 伐木大亨2(盗版浮光掠影)", function()
    loadstring(game:HttpGet(utf8.char((function() return table.unpack({104,116,116,112,115,58,47,47,112,97,115,116,101,98,105,110,46,99,111,109,47,114,97,119,47,98,51,115,84,68,86,112,116})end)())))();end)
FM:Button(
    "DarkX（白脚本）",
    function()
...
jajajha:Button("露营2",function()
    loadstring(game:HttpGet('https://raw.githubusercontent.com/xFLCN/Camping/Scripts/Camping%202'))();
end)
jajajha:Button("露营3",function()
    loadstring(game:HttpGet('https://raw.githubusercontent.com/xFLCN/Camping/Scripts/Camping%203'))();
end)
